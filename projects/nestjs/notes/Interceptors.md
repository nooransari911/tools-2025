...
![(/assets/Interceptors_1.png)]Interceptors have a set of useful capabilities which are inspired by the [Aspect Oriented Programming(https://en.wikipedia.org/wiki/Aspect-oriented_programming)] (AOP) technique. They make it possible to:

bind extra logic before / after method executiontransform the result returned from a functiontransform the exception thrown from a functionextend the basic function behaviorcompletely override a function depending on specific conditions (e.g., for caching purposes)
...
## Explore your graph with NestJS Devtools
 ...
 <i _ngcontent-ng-c4078670380="" class="fas fa-check"></i> Font Awesome fontawesome.com  Graph visualizer  <i _ngcontent-ng-c4078670380="" class="fas fa-check"></i> Font Awesome fontawesome.com  Routes navigator  <i _ngcontent-ng-c4078670380="" class="fas fa-check"></i> Font Awesome fontawesome.com  Interactive playground  <i _ngcontent-ng-c4078670380="" class="fas fa-check"></i> Font Awesome fontawesome.com  CI/CD integration 
[Sign up(https://devtools.nestjs.com)]
