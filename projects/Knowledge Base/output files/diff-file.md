# Complete Hugo Theme Changes
Generated on: Mon Jun 30 09:11:14 PM IST 2025
Original theme: /home/ansarimn/Downloads/papermod
Modified theme: /home/ansarimn/Downloads/essays/themes/papermod/

## Modified Files (Diffs)

### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/js/fastsearch.js
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/js/license.js
```
/*
  PaperMod v8+
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/js/fuse.basic.min.js
```
/**
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/main.css
```
.main {
    position: relative;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/footer.css
```
.footer,
.top-link {
    font-size: 12px;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/profile-mode.css
```
.buttons,
.main .profile {
    display: flex;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/header.css
```
.nav {
    display: flex;
    flex-wrap: wrap;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/post-entry.css
```
.first-entry {
    position: relative;
    display: flex;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/404.css
```
.not-found {
    position: absolute;
    left: 0;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/post-single.css
```
.page-header,
.post-header {
...
.toc .inner ul {
    ...
    padding-left: 0;       /* Remove default browser padding for the top-level list */
    margin-top: 0.5em;     /* Optional: Adjust top margin */
    margin-bottom: 0.5em;  /* Optional: Adjust bottom margin */
}

/* Styling for nested <ul> elements (sub-levels) */
.toc .inner ul ul {
    padding-left: 80px;    /* Indentation for nested lists. Adjust "20px" as needed.
    This creates the visual hierarchy. "1.5em" or "1.2em" can also work well. */
    margin-top: 0.25em;    /* Optional: Adjust spacing for sub-lists */
    margin-bottom: 0.25em; /* Optional: Adjust spacing for sub-lists */
    /*padding-bottom: 40px;*/
...
.toc .inner li {
    margin-top: 0.5em; /* Spacing between ToC items */
    margin-bottom: 0.5em; /* Spacing between ToC items */
    padding-left: var(--toc-padding-left);
}
...
.toc .inner a {
    ...
    color: inherit;        /* Use the parent text color for links, or specify a color */
    display: block;        /* Make links block-level for easier clicking if desired */
}

.toc .inner a:hover,
.toc .inner a:focus {
    text-decoration: underline; /* Add underline on hover/focus for accessibility */
    /* color: #your-link-hover-color; */ /* Optional: change color on hover */
}

/* Styling for the <details> summary (the "Table of Contents" title bar) */
.toc details summary {
    cursor: pointer;
    font-weight: bold; /* Make "Table of Contents" text bold */
    margin-bottom: 0.5em; /* Space below the summary bar when open */
    padding: 20px;
    /*
    padding-top: 40px;
    padding-bottom: 40px;
...
/* Optional: Style for the details marker (arrow) */
.toc details summary::-webkit-details-marker {
    /* Style for Chrome/Safari */
}
.toc details summary::marker {
    /* Style for Firefox - though often ::-webkit-details-marker is enough or it's styled by browser theme */
}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/archive.css
```
.archive-posts {
    width: 100%;
    font-size: 16px;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/terms.css
```
.terms-tags li {
    display: inline-block;
    margin: 10px;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/common/search.css
```
#searchbox input {
    padding: 4px 10px;
    width: 100%;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/includes/chroma-styles.css
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/includes/chroma-mod.css
```
.chroma {
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/includes/scroll-bar.css
```
/* from reset */
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/core/theme-vars.css
```
:root {
    --gap: 24px;
    --content-gap: 20px;
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/core/reset.css
```
*,
::after,
::before {
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/core/license.css
```
/*
  PaperMod v8+
  License: MIT https://github.com/adityatelange/hugo-PaperMod/blob/master/LICENSE
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/core/zmedia.css
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/assets/css/extended/blank.css
```
/*
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/README.md
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/inTextImg.html
```
{{- $Img := (.Get "url") }}
{{- $height := (.Get "height") }}
{{- $alt := (.Get "alt") }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/rtl.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/rawhtml.html
```
<!-- raw html -->
{{- .Inner -}}```

### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/collapse.html
```
{{ if .Get "summary" }}
{{ else }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/ltr.html
```
{{ $.Scratch.Set "md" false }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/shortcodes/figure.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/404.html
```
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <style>
      :root {
        ...
        --shadow-glow: 0 25px 50px -12px rgba(0, 0, 0, 0.8);
      ...
      * {
      ...
      /* Additional glass overlay for deeper darkness */
      body::after {
        content: "";
        position: fixed;
        top: 0;
    ...
    <div class="container">
      ...
      <div class="search-hint">
        ...
        <div class="quick-search">
          <a href="{{ $.Site.BaseURL }}" class="search-tag"
            >{{ $.Site.Title }}</a
          >
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/404-alt.html
```
<!DOCTYPE html>
<html lang="en">
  <head>
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/terms.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/list.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/single.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/baseof.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/search.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/archives.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/ list debug 2.html
```
{{- define "main" }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/_markup/render-image.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/_default/list debug.html
```
{{- define "main" }}
...
{{- end }}
    ...
    <!-- DEBUGGING START (Reflects the new variables) -->
    <hr>
    <p>DEBUGGING INFO FOR: {{ .Permalink }} (Kind: {{ .Kind }})</p>
    <p>Title: {{ .Title }}</p>
    <p>Is Home: {{ .IsHome }}; Is Section: {{ .IsSection }}; Is Page: {{ .IsPage }}</p>
    <p>Original .Pages count (Hugo's default for this context): {{ len .Pages }}</p>
    <p>Original .Sections count (Hugo's default for this context): {{ len .Sections }}</p>
    <hr>
    <p>ITEMS TO BE PAGINATED ($pages_to_list - count: {{ len $pages_to_list }}):</p>
    <pre><code>$pages_to_list: {{ $pages_to_list | jsonify (dict "indent" "  ") }}</code></pre>

    {{- $paginator_debug := .Paginate $pages_to_list -}}
    <p>PAGINATOR PAGES ($paginator_debug.Pages - count: {{ len $paginator_debug.Pages }}):</p>
    {{ if $paginator_debug.Pages }}
        <pre><code>$paginator_debug.Pages: {{ $paginator_debug.Pages | jsonify (dict "indent" "    ") }}</code></pre>
    {{ else }}
        <p style="color: red;">$paginator_debug.Pages is EMPTY!</p>
    {{ end }}

    <p>SUBSECTIONS TO DISPLAY SEPARATELY ($subsections_to_display - count: {{ len $subsections_to_display }}):</p>
    <pre><code>$subsections_to_display: {{ $subsections_to_display | jsonify (dict "indent" "    ") }}</code></pre>
    <hr>
    <!-- DEBUGGING END -->
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/svg.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/footer.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/index_profile.html
```
<div class="profile">
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/post_canonical.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/edit_post.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/header.html
```
{{- /* theme-toggle is enabled */}}
{{- if (not site.Params.disableThemeToggle) }}
    {{- /* theme is light by config */}}
    {{- if (eq site.Params.defaultTheme "light") }}
<script>
    if (localStorage.getItem("pref-theme") === "dark") {
        document.body.classList.add('dark');
    } else { // localStorage is 'light' or not set, so adhere to 'light' default
        document.body.classList.remove('dark');
    }
</script>
    {{- /* theme is dark by config, or auto/unset (which will now default to dark) */}}
    {{- else }}
<script>
    if (localStorage.getItem("pref-theme") === "light") {
        document.body.classList.remove('dark');
    } else { // localStorage is 'dark' or not set, so default to 'dark'
        document.body.classList.add('dark');
    }
</script>
    {{- end }}
...
{{- else }}
    {{- /* Theme is "dark" by config, and toggle is disabled */}}
    {{- if (eq site.Params.defaultTheme "dark") }}
<script>
    document.body.classList.add('dark');
</script>
    {{- /* Theme is "auto" (or not set) by config, and toggle is disabled - respect system preference */}}
    {{- else if (and (ne site.Params.defaultTheme "light") (ne site.Params.defaultTheme "dark"))}}
<script>
    if (window.matchMedia('(prefers-color-scheme: dark)').matches) {
        document.body.classList.add('dark');
    }
    // If system prefers light and defaultTheme is auto (and toggle disabled), it remains light.
</script>
    {{- /* Theme is "light" by config, and toggle is disabled - no script needed to enforce light if body starts light */}}
    {{- end }}
{{- end }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/breadcrumbs.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/toc default.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/share_icons.html
```
{{- $pageurl := .Permalink }}
{{- $title := .Title }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/translation_list.html
```
{{- if .IsTranslated -}}
{{- if (ne .Layout "search") }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/favicons.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/head.html
```
<meta charset="utf-8">
...
<link rel="canonical" href="{{ if .Params.canonical -}}
...
<meta name="{{ $.Site.Params.google_site_ver_key }}" content="{{ $.Site.Params.google_site_ver_value }}" />



{{/* Handle YAML array of maps structure */}}
{{- with .Params.meta -}}
  {{- range . -}}
...
{{- with .Params.meta -}}
  {{- if reflect.IsSlice . -}}
    ...
    {{- range . -}}
      {{- if reflect.IsMap . -}}
        {{- range $key, $value := . -}}
          {{- if eq $key "name" -}}{{- $.Scratch.Set "name" $value -}}{{- end -}}
          {{- if eq $key "content" -}}{{- $.Scratch.Set "content" $value -}}{{- end -}}
        {{- end -}}
        <meta name="{{ $.Scratch.Get "name" }}" content="{{ $.Scratch.Get "content" }}" />
      {{- end -}}
    {{- end -}}
...
<link rel="icon" type="image/png" sizes={{ .Site.Params.favicon_size }}x{{ .Site.Params.favicon_size }} href="/favicon-512.png">
...
<link rel="alternate" hreflang="{{ .Lang }}" href="{{ if .Params.canonical -}}
                                {{- absURL .Params.canonical -}}
                            {{- else if .Params.canonicalURL -}}
                                {{- trim .Params.canonicalURL " " -}}
                            {{- else -}}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/extend_head.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/author.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/social_icons.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/home_info.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/extend_footer.html
```
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/2.7.1/lightgallery.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/2.7.1/plugins/zoom/lg-zoom.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

<script>
  document.addEventListener('DOMContentLoaded', function () {
    const galleries = document.querySelectorAll('.custom-lightgallery'); // Matches class from shortcode
    galleries.forEach(gallery => {
      lightGallery(gallery, {
        plugins: [lgZoom, lgThumbnail], // Add plugins here
        selector: '.lg-item', // Tells lightgallery to use children with this class
        thumbnail: true,
        animateThumb: false,
        zoomFromOrigin: false, // Can improve performance on some devices
        allowMediaOverlap: true,
        toggleThumb: true,
        download: false, // Set to true to enable download button
        // Add other lightgallery options here
        // e.g. mode: 'lg-fade', speed: 500,
      });
    });
  });
</script>
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/toc.html
```
{{/*
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/anchored_headings.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/comments.html
```
{{- /* Comments area start */ -}}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/post_nav_links.html
```
{{- $pages := where site.RegularPages "Type" "in" site.Params.mainSections }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/post_meta.html
```
{{- $scratch := newScratch }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/cover.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/templates/_funcs/get-page-images.html
```
{{- $imgs := slice }}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/templates/opengraph.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/templates/schema_json.html
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/layouts/partials/templates/twitter_cards.html
```
{{- if .Params.cover.image -}}
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ms.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/id.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/bn.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/be.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ro.yaml
```
- id: prev_page
  translation: "Înapoi"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ja.yaml
```
- id: prev_page
  translation: "前へ"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ca.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/pl.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/zh.yaml
```
- id: prev_page
  translation: "上一页"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ru.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/tr.yaml
```
- id: prev_page
  translation: "Önceki"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/da.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/eo.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/bg.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ku.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/mn.yaml
```
- id: prev_page
  translation: "Ѳмнѳх"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/no.yaml
```
- id: prev_page
  translation: "Forrige Side"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/es.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/cs.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/el.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ckb.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ar.yaml
```
- id: prev_page
  translation: "السابق"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/he.yaml
```
- id: prev_page
  translation: "הקודם"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/pnb.yaml
```
- id: prev_page
  translation: "پِچھلا"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/nl.yaml
```
- id: prev_page
  translation: "Vorige"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/hr.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/vi.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/sv.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/th.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/en.yaml
```
- id: prev_page
  translation: "Prev"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/pt.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/uk.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/oc.yaml
```
- id: prev_page
  translation: "Prec."
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/zh-tw.yaml
```
- id: prev_page
  translation: "上一頁"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/uz.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/ko.yaml
```
- id: prev_page
  translation: "이전 페이지"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/hi.yaml
```
- id: prev_page
  translation: "पिछला"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/fa.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/de.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/it.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/sw.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/pa.yaml
```
- id: prev_page
  translation: "ਪਿਛਲਾ"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/fr.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/hu.yaml
```
- id: prev_page
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/i18n/sk.yaml
```
- id: prev_page
  translation: "Predch"
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/.github/PULL_REQUEST_TEMPLATE.md
```
<!--
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/.github/workflows/gh-pages.yml
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/.github/ISSUE_TEMPLATE/enhancement.yaml
```
name: Enhancement 🚀
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/.github/ISSUE_TEMPLATE/config.yml
```
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/.github/ISSUE_TEMPLATE/bug.yaml
```
name: Bug Report 🐞
...
### New File: /home/ansarimn/Downloads/essays/themes/papermod/theme.toml
```
