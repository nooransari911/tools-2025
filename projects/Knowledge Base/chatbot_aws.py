...
def generate_response(bedrock_client, model_id, system_prompts, messages):
    """
...
def run_chatbot():
    ...
    bedrock_client = configure_bedrock_client()
    ...
    while True:
        try:
            ...
            if user_input:
                ...
                response_message = generate_response(bedrock_client, model_id, system_prompts, messages)
                end_time = time.time()
