...
def run_chatbot():
    ...
    """
    <trim>
    The removed code is just chatbot runtime—a `while (true):` loop handling user input, generating model responses, and maintaining history. User input and model response are converted to messages using prepare_message() function.
    </trim>
    """
...
"""
<trim>
The removed code is gemini_generate.log_entry_exit(func) and gemini_generate.logger. They setup logginf for the app and provide decorator to log entry and exit into functions. Refer gemini_generate.py
</trim>
"""

"""
<trim>
The removed code is some signal handling and debugging functions
</trim>
"""

"""
<trim>
The removed code is gemini_generate.load_system_instructions() and gemini_generate.configure_genai(). THey load system instructions and provide a gemini model of required name and API key. Refer gemini_generate.py
</trim>
"""
...
def run_chatbot():
    ...
    """
    <trim>
    The removed code is just chatbot runtime—a `while (true):` loop handling user input, generating model responses, and maintaining history. Refer deepseek_chatbot.py
    </trim>
    """
